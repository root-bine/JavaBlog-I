...
```java
当出现需要抽取一个共有方法，来解决两个默认方法之间的重复代码问题。
    那么这个共有方法的访问权限，应该时私有的！！
```
...
2. 静态私有方法：<span style="color:yellow">解决多个静态方法中重复代码问题</span>
...
3. <span style="color:yellow">多个父接口中有重复的默认方法，**子接口需要覆盖重写这个方法**</span>；
